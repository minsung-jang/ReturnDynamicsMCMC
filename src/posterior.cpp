...
double ReturnDynamicsMCMC::posterior_E_mu(mt19937_64& generator, VectorXd& mu_vec, VectorXd& Y_vec, bool DEBUG)
{
    if (DEBUG)
...
double ReturnDynamicsMCMC::posterior_beta(mt19937_64& generator, VectorXd& mu_vec, VectorXd& Y_vec, bool DEBUG){
    ...
    Delta_t = Delta_t / sig_mu;
    VectorXd Delta_tp1 = mu_vec.tail(T)-E_mu*ones;
    Delta_tp1 = Delta_tp1 / sig_mu;
...
vector<double> ReturnDynamicsMCMC::posterior_phi_omega(mt19937_64& generator,
                                                       VectorXd& mu_vec, VectorXd& Y_vec, bool DEBUG)
{
    if (DEBUG)
...
void ReturnDynamicsMCMC::posterior_mu(mt19937_64& generator, VectorXd& mu_vec, VectorXd& Y_vec, bool DEBUG)
{
    assert(T >=2);
